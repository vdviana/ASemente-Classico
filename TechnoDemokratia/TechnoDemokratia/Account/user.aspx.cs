...
using TechnoDemokratia.Models;
using Facebook;
using static TechnoDemokratia.Models.Facebook;

namespace TechnoDemokratia.account
{
    public partial class user : System.Web.UI.Page
    {
        ...
        protected List<FacebookUser> GetFacebookUserData(string code)
        {
            ...
            Uri targetUri = new Uri("https://graph.facebook.com/access_token?client_id=" + code);
